...
## 1. Quick Start: Create a Minimal Experiment
...
- [Agent Design](./agent-design.md) – Advanced agent configuration
- [Platform Design](./platform-design.md) – Architecture overview
